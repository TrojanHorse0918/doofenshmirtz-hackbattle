...
def get_chemists(start_long, start_lat):
...
def get_hospitals(start_long, start_lat):
    print("Start city: ", cf.get_city_from_lat_lng(start_lat, start_long))
...
def get_policeStations(start_long, start_lat):
    print("Start city: ", cf.get_city_from_lat_lng(start_lat, start_long))
...
def get_childcare(start_long, start_lat):
    print("Start city: ", cf.get_city_from_lat_lng(start_lat, start_long))
